...
% Figure 3A
%
% Plots output of LME analysis of NA
%
...
% arousal(arousal==-1)= 0; % simple-effect of stimulus for low arousal
% arousal(arousal==+1)= 0; % simple-effect of stimulus for high arousal
% stimulus(stimulus==-1)= 0; % simple-effect of arousal for standard
% stimulus(stimulus==+1)= 0; % simple-effect of arousal for oddball
% Format
...
for i_var= 1:length(plot_order);
    ...
    barh(i_var,c_beta_est,'LineWidth',lw,'Facecolor',[0 225 0]./255,'Edgecolor',[0 0 0],'FaceAlpha',.5);
...
axis square;
% Print
print('-djpeg','-r300',['Figures/Figure-3A-',NT_for_plot]);
...
% Figure 3B
%
% Plots critical conditions for NA
%
...
v_var= [-1 1];
for i_var= 1:2;
    barz{i_var,1}= NT(stimulus==v_var(i_var) & arousal==-1);
    barz{i_var,2}= NT(stimulus==v_var(i_var) & arousal==+1);
end
% Create figure
...
axis square;
% Print
print('-djpeg','-r300',['Figures/Figure-3B-',NT_for_plot]);